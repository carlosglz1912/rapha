"""scripts/_lib/cli.py — shared scaffolding for the `rapha-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("rapha-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/rapha-foo`
...
VERSION = "0.1.0"  # bumped centrally; every rapha-* CLI reports this
