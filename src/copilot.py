...
COPILOT_USER_AGENT = os.environ.get(
    "RAPHA_COPILOT_USER_AGENT", "Rapha/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "RAPHA_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "RAPHA_COPILOT_EDITOR_VERSION", "Rapha/1.0"
)
