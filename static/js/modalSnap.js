...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'rapha-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'rapha-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('rapha:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
