...
function initMermaid() {
  if (!window.mermaid || window.__raphaMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__raphaMermaidReady = true;
}
window.raphaInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'rapha-thinking-expanded';
