...
const LS_KEY = 'rapha-theme';
const CUSTOM_THEMES_KEY = 'rapha-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Rapha Logo',    group: 'Sidebar' },
...
const UI_SCALE_KEY = 'rapha-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'rapha_' + (obj.name || 'theme') + '.json';
      a.click();
