...
const _ACTION_RECENTS_KEY = 'rapha-msg-actions-recent';
 ...
 */
const _USER_ACTION_RECENTS_KEY = 'rapha-user-actions-recent';
...
export function addMessage(role, content, modelName, metadata) {
  try {
    ...
    var _roleText = role === 'user' ? 'You' : (isSlash || isCompacted) ? 'Rapha' : modelRouteLabel(replyModels.requestedModel, resolvedModel);
