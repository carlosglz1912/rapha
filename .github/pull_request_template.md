...
- [ ] I searched [open issues](https://github.com/carlosglz1912/rapha/issues) and [open PRs](https://github.com/carlosglz1912/rapha/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Rapha's existing visual language. Specifically:
