...
Rapha is an independent fork of **[Odysseus](https://github.com/pewdiepie-archdaemon/odysseus)** by PewDiePie / pewdiepie-archdaemon. The core workspace architecture, agent loop, Cookbook integration, and much of the original codebase come from that project (MIT License). Rapha specializes that foundation for private, health-adjacent professional use.

Rapha stands on the shoulders of a lot of open-source work. This file
...
- **[Tongyi DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)** by
  **Alibaba-NLP / Tongyi Lab** — the multi-step deep-research agent pipeline.
  Copyright © Alibaba-NLP / Tongyi Lab. **Apache-2.0.** Adapted for Rapha's
...
- **`caldav`** (Python lib) is **dual-licensed GPL-3.0-or-later OR Apache-2.0**.
  Rapha uses it under **Apache-2.0**, which is permissive and MIT-compatible.
...
Most of Rapha's code was written *with* AI models, not just by a human.
