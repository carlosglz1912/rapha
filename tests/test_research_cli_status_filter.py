"""`rapha-research list --status complete` was returning nothing.
...
Part of #2122 (rapha-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "rapha-research"
    loader = importlib.machinery.SourceFileLoader("rapha_research_cli", str(path))
